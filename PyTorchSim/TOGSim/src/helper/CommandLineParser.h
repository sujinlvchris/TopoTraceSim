...
class CommandLineParser {
  public:
     ...
     * (This can fail and raise exception of type
     * CommandLineParser::ParsingError)
     * @param argc
     * @param argv
     */
     ...
     */
    template <typename T> void set_if_defined(const char *arg_name, T *target_var) const noexcept {
